-- Repairs environments where flyway_schema_history is ahead of the actual schema
-- (e.g. schema version 3 recorded but V2 never created audit_log).
-- Safe to run on databases that already have the table.
